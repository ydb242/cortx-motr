...
#define DUMMY_SERVER_ADDR "inet:tcp:127.0.0.1@3010"
...
static const char client_addr[] = "inet:tcp:127.0.0.1@3001";
static const char server_addr[] = "inet:tcp:127.0.0.1@3000";

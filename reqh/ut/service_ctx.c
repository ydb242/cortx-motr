...
static const char               *ut_ep_addr_remote = "inet:tcp:127.0.0.1@3999";
...
static void ut_dead_end__connecting(void)
{
	 ...
	 * natural way due to "inet:tcp:127.0.0.1@3999" endpoint unavailable.
	 */
 ...
 *
 * We are to start without "inet:tcp:127.0.0.1@3999" remote end and then see if we can
 ...
 * with disconnection.
 *
 * This time a separate rpc machine is launched to let "inet:tcp:127.0.0.1@3999"
